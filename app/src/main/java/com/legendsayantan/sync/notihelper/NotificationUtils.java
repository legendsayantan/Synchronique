package com.legendsayantan.sync.notihelper;
...
import com.legendsayantan.sync.notihelper.models.Action;
import com.legendsayantan.sync.notihelper.models.NotificationIds;
...
public class NotificationUtils {
    ...
    public static boolean isRecent(StatusBarNotification sbn, long recentTimeframeInSecs) {
        return sbn.getNotification().when > 0 &&  //Checks against real timestamp to make sure its new
