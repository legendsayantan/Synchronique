package com.legendsayantan.sync.views.chatview.adapter
...
import com.legendsayantan.sync.views.chatview.util.SimpleChatUtil.Companion.getTimeAgo
import com.legendsayantan.sync.views.chatview.ChatView.Companion.TYPE_IMAGE
import com.legendsayantan.sync.views.chatview.ChatView.Companion.TYPE_TEXT
import com.legendsayantan.sync.views.chatview.ChatView.Companion.TYPE_VIDEO
    ...
    inner class TypeTextSend(private val binding: SendTextMessageItemBinding) :
        ...
        fun bind(position: Int) {
            binding.apply {
                ...
                txtMessage.setTextColor(if(context.resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK == Configuration.UI_MODE_NIGHT_YES) context.getColor(com.legendsayantan.sync.R.color.accent1_600) else context.getColor(com.legendsayantan.sync.R.color.accent1_200))
                txtMessage.backgroundTintList = ColorStateList.valueOf(
                    if(context.resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK == Configuration.UI_MODE_NIGHT_YES) context.getColor(com.legendsayantan.sync.R.color.accent1_200) else context.getColor(com.legendsayantan.sync.R.color.accent1_600))
                txtDate.text = getTimeAgo(chatMessage[position].timestamp)
                txtDate.setTextColor(if(context.resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK == Configuration.UI_MODE_NIGHT_YES) Color.WHITE else Color.BLACK)
